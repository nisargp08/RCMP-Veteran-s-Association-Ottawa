    ...
    <div class="container text-center text-md-left">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-3 mx-auto my-md-4 my-0 mt-4 mb-1">
                ...
                <p>Ottawa Division P.O Box 42020<br>
                1200 St Laurent Blvd, Ottawa, ON, K1K 4L8</p>
...
<script src="<?php get_template_directory('/assets/javascript/popper.min.js') ?>"></script>
